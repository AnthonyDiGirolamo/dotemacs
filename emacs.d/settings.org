...
*** doom-one-theme and overrides
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     ;;   :ensure t
     ;;   :config
     ;;    (let ((doom-theme-name (if (display-graphic-p) 'doom-one 'doom-molokai )))
     ...
     ;;       `(org-level-1 ((t (:height 1.4 :weight bold   :slant normal :foreground "#00B3EF" :background "#21272d" :underline nil :box (:line-width 4 :color "#21272d" :style nil)))))
     ;;       `(org-level-2 ((t (:height 1.2 :weight bold   :slant normal :foreground "#88aaff" :underline nil))))
     ;;       )
     ;;    )
     ;; )
