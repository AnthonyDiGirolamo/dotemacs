...
* evil-mode
  #+BEGIN_SRC emacs-lisp
    (use-package evil
      ...
      ;; (define-key evil-motion-state-map "?" 'evil-search-forward) ;; bind evil search to ?
    ...
    (use-package expand-region
      :config
      (define-key evil-normal-state-map (kbd "gx") 'er/expand-region))
  #+END_SRC
...
* auto-completion
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package yankpad
      ...
      :config
      (define-key evil-insert-state-map (kbd "C-/") 'yankpad-expand)
      (define-key evil-insert-state-map (kbd "C-M-/") 'yankpad-insert))
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    FUN function callback"
      ...
      (evil-define-key 'normal evil-org-mode-map
        "N" '(lambda () (interactive) (outline-next-heading) (recenter))
        "E" '(lambda () (interactive) (outline-previous-heading) (recenter))
