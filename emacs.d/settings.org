...
* evil-mode
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package evil-visualstar
      :ensure t
      :commands (evil-ex-search-word-forward evil-ex-search-word-backward)
      :after evil)

    (use-package evil-surround
      :ensure t
      :commands (evil-surround-line evil-surround-line)
      :config
...
* auto-completion
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package yankpad
      ...
      :config
      (define-key evil-insert-state-map (kbd "C-t") 'yankpad-expand))
