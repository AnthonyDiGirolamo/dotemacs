   ...
   #+BEGIN_SRC emacs-lisp
     (use-package moe-theme
       ...
       (custom-theme-set-faces
        ...
        `(org-level-1 ((t (:height 1.3 :weight bold   :slant normal :foreground "#aa88ff" :background "#4e4e4e" :underline nil :box (:line-width 4 :color "#4e4e4e" :style nil)))))
        `(org-level-2 ((t (:height 1.1 :weight bold   :slant normal :foreground "#88aaff" :background "#4e4e4e" :underline nil :box (:line-width 4 :color "#4e4e4e" :style nil)))))
...
* hydras
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (defhydra hydra-eyebrowse (:color red :columns 3)
      ...
      ("l"  amd/eyebrowse-next-or-new-window-config   "→ new")
