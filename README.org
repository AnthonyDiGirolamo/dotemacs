  ...
  #+BEGIN_SRC emacs-lisp
    (defun amd/set-font ()
      ...
      (when (display-graphic-p)
        ...
        ;; (set-frame-font (font-spec :name "Iosevka Fixed SS08 Light" :antialias t :size 16.0)) ;; point size
...
** Main Leader Hydra
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (pretty-hydra-define hydra-set-toggles (:color amaranth :quit-key "q")
       ("s: Set Toggles"
        (("t" toggle-truncate-lines "truncate-lines" :toggle truncate-lines)
         ("i" fci-mode "fill column indicator mode" :toggle t)
         ("f" auto-fill-mode "auto-fill-mode" :toggle auto-fill-function)
         ("L" display-line-numbers-mode "display-line-numbers-mode" :toggle t)
         ("l" nlinum-mode "nlinum-mode" :toggle t)
         ("r" nlinum-relative-mode "nlinum-relative-mode" :toggle t)
         ("h" hl-line-mode "hl-line-mode" :toggle t)
         ("d" rainbow-delimiters-mode "rainbow-delimiters-mode" :toggle t)
         ("c" color-identifiers-mode "color-identifiers-mode" :toggle t)
         )))
