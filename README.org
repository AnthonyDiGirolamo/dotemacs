...
*** doom-one-theme
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package doom-themes
       :config
       (defun amd/doom-one-theme-add-brighten-hook ()
          (interactive)
          ;; (add-hook 'find-file-hook 'doom-buffer-mode) ;; brighter source buffers
          (add-hook 'minibuffer-setup-hook 'doom-brighten-minibuffer) ;; brighter minibuffer when active
       )
   ...
   #+BEGIN_SRC emacs-lisp
     (use-package powerline
       ...
       (cond ((eq system-type 'cygwin)    (setq powerline-height 26))
             ...
             ((eq system-type 'gnu/linux) (setq powerline-height 24))
             (t                           (setq powerline-height 20)))
     )
...
** load theme
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      ;; (load-theme 'airline-doom-one t)
      ;; (amd/doom-one-theme)
      ;; (amd/doom-one-theme-add-brighten-hook)
    #+END_SRC
