    ...
    (cond ((or (eq system-type 'cygwin) (eq system-type 'windows-nt))
          ...
          ((eq system-type 'gnu/linux)
           (progn (setq amd/font-size 17)
                  (add-to-list 'default-frame-alist '(font . "PragmataPro-17:antialias=true:hinting=true:autohint=false:hintstyle=hintslight" ))))
          (t
     ...
     (amd/define-hydra-with-columns
      ...
      `(
        ...
        (
         ...
         ("pe" eshell-projectile-root           "project eshell")
