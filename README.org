  ...
  #+BEGIN_SRC emacs-lisp
    (defun amd/set-font ()
      ...
      (when (display-graphic-p)
        ...
        (cond
         ...
         ((eq system-type 'gnu/linux)
          (setq amd/font-size 16
                ;; amd/font-name "Iosevka SS08-%d:antialias=true:hinting=true:autohint=false:hintstyle=hintnone"
        ...
        (add-to-list 'default-frame-alist '(font . "PragmataPro-14:antialias=true:hinting=true:autohint=false:hintstyle=hintnone"))

        ;; (set-frame-font (font-spec :name "PragmataPro" :antialias t :size 24)) ;; pixel size
        ;; (set-frame-font (font-spec :name "PragmataPro" :antialias t :size 12.0)) ;; point size
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (use-package airline-themes
       ...
       (setq airline-utf-glyph-separator-left      #x20
             ...
             airline-utf-glyph-branch              #x20
             airline-utf-glyph-readonly            #x20
             airline-utf-glyph-linenumber          #x20)
