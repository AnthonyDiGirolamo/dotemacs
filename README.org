...
* fonts
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (setq powerline-height (floor (* 1.2 amd/font-size)))
...
* language major-modes
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package forth)
    (use-package forth-block)
    (use-package forth-interaction)
  #+END_SRC
     ...
     (amd/define-hydra-with-columns
      ...
      '((("cc" org-capture "capture")
        ...
        (("d" pandoc-main-hydra/body "pandoc")
         ...
         ("hp" amd/clipboard-html-to-org-pandoc-mac "html→org→paste")
    ...
    (use-package org
      ...
      (:states '(normal)
       :keymaps '(org-mode-map)
        ...
        "o" 'evil-open-below
        "O" '(lambda () (interactive) (amd/org-eol-call 'org-meta-return))
