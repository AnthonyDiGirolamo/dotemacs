...
** eshell
  ...
  #+BEGIN_SRC emacs-lisp
    ...
    (use-package eshell
      ...
      ;; (defadvice eshell-ls-decorated-name (after advice-for-eshell-ls-decorated-name activate)
      ...
      ;;   ;;                      ad-return-value)
      ;;   ;; ad-return-value)
      ;;   ;; (propertize (all-the-icons-icon-for-file ad-return-value)
      ;;   ;;             'face `(:family ,(all-the-icons-octicon-family))
      ;;   ;;             'display '(raise -0.1))
      ;;   (setq ad-return-value
      ;;         (concat
      ;;          (all-the-icons-icon-for-file ad-return-value)
      ;;          ad-return-value))
